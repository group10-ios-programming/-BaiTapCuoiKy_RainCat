...
public class FoodSprite : SKSpriteNode, Palettable {
  ...
  public static let foodName = ["avocado","carrot","cherries","corn","grapes","lemon","orange","pumpkin","raspberry","strawberry"]
public static var poi = 0
  public static func newInstance(palette : ColorPalette) -> FoodSprite {
    poi = Int(arc4random_uniform(UInt32(foodName.count)))
    let foodDish = FoodSprite(imageNamed: foodName[poi])
